...
CITIES = {
    "pointeDuRaz": {"lat": 48.0375, "lon": -4.7386, "name": "Pointe du Raz"},
    "quimper": {"lat": 47.9960, "lon": -4.1024, "name": "Quimper"},
    "rennes": {"lat": 48.1173, "lon": -1.6778, "name": "Rennes"},
    "dinan": {"lat": 48.4536, "lon": -2.0502, "name": "Dinan"},
    ...
    "creteil": {"lat": 48.7833, "lon": 2.4667, "name": "Créteil"},
    "gagny": {"lat": 48.8833, "lon": 2.4333, "name": "Gagny"},
}
